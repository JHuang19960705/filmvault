        ...
        <div className="archive_item">
          ...
          <div className="archive_content">
            <div className="archive_col1">
              <div>{favorite.profile_path && <a><img className="archive_kv" src={TMDB_IMG_MD + favorite.profile_path} alt={favorite.name} loading="lazy" decoding="async" /></a>}</div>
            ...
            <div className="archive_col2">
              {favoriteVideoImg && favoriteVideoImg.slice(0, 4).map((img) => <img key={img.id} src={TMDB_IMG_MD + img.poster_path} alt={img.name} loading="lazy" decoding="async" />)}
            </div>
          </div>
        </div>
      )}
