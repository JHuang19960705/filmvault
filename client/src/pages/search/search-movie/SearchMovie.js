                ...
                <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                  ...
                  {currentUser && currentUser.user.role !== "free" && (
                    <div className="w-full flex justify-around text-base text-gray-400 pt-3">
                      <Link to={`post-movie-content/${d.id}`} onClick={() => { handleClickTitle(d.title) }} className="border-b border-transparent hover:text-gray-800 hover:border-b hover:border-gray-800 dark:hover:border-gray-300 dark:hover:text-gray-300">
                        寫影評
                      </Link>
